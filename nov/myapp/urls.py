...
from . import views
from .views import delete_group, update_group, update_client,users_activity_view, delete_client, edit_subscription, subscription_list, coach_list, add_coach,add_group,group_list, add_client, add_subscription, client_list
